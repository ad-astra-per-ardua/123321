package com.cookandroid.login_front.logic;
...
import com.cookandroid.login_front.MainActivity;
import com.cookandroid.login_front.R;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        signupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Thread(() -> {
                    User existingUser = db.userDao().findById(userId);
